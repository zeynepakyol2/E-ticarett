                    ...
                    <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    Yıl
                                    <select name="son_kullanma_tarihi_yıl" class="form-control" required>
                                        <option>2017</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control telefon" name="ceptelefonu" id="ceptelefonu" required value="{{ $kullanici_detay->cep_telefonu }}">
                                </div>
                            </div>
                        </div>
                    </div>
